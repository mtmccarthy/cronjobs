...
def main():
    ...
    prices = get_price_estimate(franklin_street[0], franklin_street[1], silicon_labs[0], silicon_labs[1])
    ...
    sheet.update_acell('D' + strRowNum, prices['uberx'][0])
    sheet.update_acell('E' + strRowNum, prices['uberx'][1])
